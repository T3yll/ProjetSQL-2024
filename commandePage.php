...
<head>
  ...
  <style>
    body {
      background-image: url('public/commandePageBurger.png');
      /* Chemin vers votre image */
      background-size: cover;
      /* Ajuste la taille de l'image pour remplir l'arrière-plan */
  ...
  <style>
    .navbar-brand-logo {
      ...
      height: auto;
      /* Laissez la hauteur automatique pour maintenir les proportions */
    }
  </style>
</head>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="restaurant" name="restaurant" aria-label="Choisir un restaurant">
                  ...
                  <?php foreach ($restaurants as $restaurant) { ?>
                    <option value="<?php echo $restaurant["Nom"]; ?>">
