                    ...
                    <div class="col-lg-4 my-2">
                        <div class="card h-100 flex-fill">
                            <h5>
                                ...
                                print_r(array_keys($commandes)[$i]) ?> €
                            </h5>
                            <div class="container-fluid content-row ">
                                <form class="flex-row" action="api/update.php" method="post">

                                <input type="hidden" name="ArrayId" value="<?php echo $i ?>">
                                    <input type="hidden" name="id" value="<?php echo array_keys($commandes)[$i] ?>">
                                    <label for="">Commentaire</label>
                                    <input type="text" name="commentaire" value="<?php echo $commande["Commentaire"] ?>">
                                    <?php session_start();
                                    if (isset ($_SESSION["ErrorNumero"])): ?>
                                        <h2 class="text-danger">
                                            <?php echo $_SESSION["ErrorNumero"]; ?>
                                        </h2>
